...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
  ...
  public void process(PaymentResponse paymentResponse) {
    ...
    SagaStatus sagaStatus = orderSagaHelper.orderStatusToSagaStatus(orderPaidEvent.getOrder()
        .getOrderStatus());
  ...
  private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(String sagaId,
    ...
    if (orderApprovalOutboxMessageResponse.isEmpty()) {
      throw new OrderDomainException(MessageFormat.format(
          "Approval outbox message could not be found in {0} status!",
          SagaStatus.COMPENSATED.name()));
    }
