...
public class OrderApplicationServiceTest {
  ...
  public void init() {
    ...
    when(paymentOutboxRepository.save(any(OrderPaymentOutboxMessage.class))).thenReturn(
  ...
  public void testCreateOrderWithWrongTotalPrice() {
    ...
    assertEquals("Total Price : 250 is not equal to Order items total: 200!",
  ...
  public void testCreateOrderWithWrongProductPrice() {
    ...
    assertEquals("Order item price : 60 is not valid for product " + PRODUCT_ID,
        orderDomainException.getMessage());
  }
